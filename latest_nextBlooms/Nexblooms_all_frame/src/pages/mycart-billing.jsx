...
import styles from "./mycart-billing.module.css";

const MycartBilling = () => {
  return (
    <div className={styles.mycartBilling}>
            ...
            <div className={styles.topContainer}>
              <div className={styles.navigationContainer}>
                ...
                <div className={styles.frameParent}>
                  <div className={styles.notificationIconBackgroundParent}>
                    <div className={styles.notificationIconBackground} />
                    <div className={styles.searchByProductWrapper}>
                      <a className={styles.searchByProduct}>
                        Search by product
                      </a>
                    </div>
                    <div className={styles.cartIconBackgroundParent}>
                      <div className={styles.cartIconBackground} />
                      <img
                  ...
                  <div className={styles.authContainer}>
                    <div className={styles.frameGroup}>
                      <div className={styles.loginButtonIconParent}>
                        <img
                          ...
                          src="/vector-2.svg"
                        />
                        <div className={styles.loginButtonEllipsisParent}>
                          <div className={styles.loginButtonEllipsis} />
                      ...
                      <div className={styles.frameWrapper}>
                        <div className={styles.frameContainer}>
                          ...
                          />
                          <div
                            className={styles.accountMenuNotificationElliParent}
                          >
                            <div
                              className={styles.accountMenuNotificationElli}
                            />
                            <a className={styles.accountMenuNotification}>4</a>
                          </div>
                        </div>
                      </div>
                    </div>
            ...
            <div className={styles.footerLinksParent}>
              <nav className={styles.footerLinks}>
                ...
                <div className={styles.categoriesParent}>
                  ...
                  <div className={styles.linksIconWrapper}>
                    <img
      ...
      <footer className={styles.footer}>
        <div className={styles.footerBackgroundParent}>
          ...
          <div className={styles.footerTopParent}>
                ...
                <div className={styles.contactDetails}>
                  <div className={styles.logo3Parent}>
                    ...
                    <div className={styles.contactInformationParent}>
                      ...
                      <div className={styles.phoneWrapperParent}>
            ...
            <img
              className={styles.bottomDividerIcon}
              alt=""
